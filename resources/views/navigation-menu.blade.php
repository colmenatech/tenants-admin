        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\TenantRequest::class)
                        <x-dropdown-link href="{{ route('tenant-requests.index') }}">
                        Tenant Requests
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @can('view-any', App\Models\Subscription::class)
                <x-jet-responsive-nav-link href="{{ route('subscriptions.index') }}">
                Subscriptions
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Tag::class)
                ...
                @endcan
                @can('view-any', App\Models\TenantRequest::class)
                <x-jet-responsive-nav-link href="{{ route('tenant-requests.index') }}">
                Tenant Requests
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
                ...
                @endcan
                @can('view-any', App\Models\Tenant::class)
                <x-jet-responsive-nav-link href="{{ route('tenants.index') }}">
                Tenants
                </x-jet-responsive-nav-link>
                @endcan
