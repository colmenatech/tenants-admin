<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            @lang('crud.subscriptions.index_title')
        </h2>
    </x-slot>
                    ...
                    <table class="w-full max-w-full mb-4 bg-transparent">
                        <thead class="text-gray-700">
                            <tr>
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.subscriptions.inputs.name')
                                </th>
                                <th class="px-4 py-3 text-left">
                                ...
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.subscriptions.inputs.features_gates')
                                </th>
                                <th></th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-600">
                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-right">
                                    <pre>
{{ json_encode($subscription->entities_threshold) ?? '-' }}</pre
                                    >
                                </td>
                                <td class="px-4 py-3 text-right">
                                    <pre>
{{ json_encode($subscription->features_gates) ?? '-' }}</pre
                                    >
                                </td>
                                <td
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        @endcan @can('delete', $subscription)
                                        <form
