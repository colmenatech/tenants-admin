...
class PermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        Permission::create(['name' => 'list tenantrequests']);
        Permission::create(['name' => 'view tenantrequests']);
        Permission::create(['name' => 'create tenantrequests']);
        Permission::create(['name' => 'update tenantrequests']);
        Permission::create(['name' => 'delete tenantrequests']);
